...
class LineChartTooltipHelperPainterModel {
  final Size size;
  final double? cursorPosition;
  final LineChartStockPerformanceModel stockData;
  final Animation<double> animation;
  late final LineChartSelectedPositionHelperModel _position;
  late TextPainter _textPainter;

  LineChartTooltipHelperPainterModel({
    required this.size,
    required this.cursorPosition,
    required this.stockData,
    required this.animation,
  }) {
    _position = LineChartSelectedPositionHelperModel(stockData: stockData, size: size, cursorPosition: cursorPosition);
